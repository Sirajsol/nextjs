...
const InvitationSentRow = ({inv,setInvId,setEShow,setIEShow}) => {
    ...
    <div className=" flex flex-1 border-[1px] justify-end items-center bg-blue-600 text-[20px]  whitespace-nowrap  overflow-hidden "><div className=" mr-[5px]  justify-end text-white hover:overflow-scroll">{inv.createdDate}</div></div>
  ...
  <div className=" flex flex-1 border-[1px] justify-end items-center bg-blue-600 text-[20px]  whitespace-nowrap  overflow-hidden "><div className=" mr-[5px]  justify-end text-white hover:overflow-scroll">{inv.email}</div></div>
    ...
    <div  className=" flex flex-1 border-[1px] justify-end items-center bg-blue-600 text-[20px]  whitespace-nowrap ">
        <Checkbox  checked={inv.affirm=="نعم"} disabled ></Checkbox></div>
    </div>
